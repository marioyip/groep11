...
<div class="container marginTop20 radius">
    <div class="col-md-12 privacyverklaring " align="left">
        ...
        <p>Wij zijn er van bewust dat u vertrouwen stelt in ons. Wij zien het dan ook als onze verantwoordelijkheid om
            ...
            gebruikt, waarom we deze gegevens verzamelen en hoe we hiermee uw gebruikservaring verbeteren. Zo snapt u
            precies hoe wij werken.</p>
        <p>Dit privacybeleid is van toepassing op de diensten van EenmaalAndermaal. U dient zich ervan bewust te zijn
            dat EenmaalAndermaal niet verantwoordelijk is voor het privacybeleid van andere sites en bronnen. Door
        ...
        <h2>Communicatie</h2>
        <p>Wanneer u e-mail of andere berichten naar ons verzendt, is het mogelijk dat we die berichten bewaren. Soms
            vragen wij u naar uw persoonlijke gegevens die voor de desbetreffende situatie relevant zijn. Dit maakt het
            mogelijk uw vragen te verwerken en uw verzoeken te beantwoorden. De gegevens worden opgeslagen op eigen
            beveiligde servers van EenmaalAndermaal of die van een derde partij. Wij zullen deze gegevens niet
            combineren met andere persoonlijke gegevens waarover wij beschikken.</p>
        <h2>Doeleinden</h2>
        <p>We verzamelen of gebruiken geen informatie voor andere doeleinden dan de doeleinden die worden beschreven in
        ...
        <p>Deze privacyverklaring is afgestemd op het gebruik van en de mogelijkheden op deze site. Eventuele
            aanpassingen en/of veranderingen van deze site, kunnen leiden tot wijzigingen in deze privacyverklaring. Het
